        ...
        if ($.trim(consent) !== '') {
            $.ajax({
                ...
                error: function (error) {
                    ...
                    $('#parser_error').html('<textarea class="form-control p-2 mb-2 rounded result-error" readonly>' + data.error + '</textarea>');
    ...
    $('#composer_form').submit(function (event) {
        ...
        $.ajax({
            ...
            error: function (error) {
                ...
                $('#composer_error').html('<textarea class="form-control p-2 mb-2 rounded-1 result-error" readonly>' + data.error + '</textarea>');
